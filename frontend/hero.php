<section class="hero-module">
    <div class="swiper hero-swiper">
        <div class="swiper-wrapper">
            <div class="hero swiper-slide" style="background-image: url('http://localhost/argo/wp-content/themes/argo/images/hero.jpg')">
                <div class="overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 text-wrapper">
                            <h1 class="heading">No 1. Alliance & Community of <span class="bold-text">Responsible Gun Owners</span></h1>
                            <p class="description">ARGO will provide the necessary authority and resources to enact change and knowledge within the community of responsible gun owners</p>
                            <a href="" class="btn btn-primary">Be a part of it</a>
                            <div class="swiper-nav d-none d-lg-flex">
                                <div class="swiper-button-prev-hero">
                                ...
                                <div class="swiper-button-next-hero">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
