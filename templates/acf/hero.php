...
<section class="hero-module">
    <div class="swiper hero-swiper">
        ...
        <?php foreach( $params['slides'] as $k => $v ) { ?>
            <div class="hero swiper-slide" style="background-image: url('<?php echo wp_get_attachment_image_url( $v['image']['id'], 'full' ); ?>'); background-position: <?php echo $v['image']['left'] . "% " . $v['image']['top'] . "%"; ?>">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 text-wrapper">
                            ...
                            <?php 
                            if( $v['button_group']['type'] == 'button' ) {
                                echo get_btn( $v['button_group'] ); 
                            } else { ?>
                            <div class="col-12 col-md-4">
                                <?php echo do_shortcode( $v['button_group']['form_shortcode'] ); ?>
                            </div>
                            <?php } ?>
                            <?php if( count( $params['slides'] ) > 1 ) { ?>
